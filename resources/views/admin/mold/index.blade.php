                ...
                <div class="col-12">
                    <div class="card bg-dark">
                        <div class="card-header border-bottom">
                            <h4 class="card-title text-white">All Molds</h4>
                            <a href="{{ route('mold.create') }}"><button type="submit" class="float-right btn btn-common mr-3">Create New</button></a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach($molds as $mold)
                                            <tr>
                                                ...
                                                <td><a href="{{ route('mold.edit',$mold->id) }}"><span class="fa fa-edit"></span></a></td>
                                                <td><a href="{{ route('mold.show',$mold->id) }}"><span class="fa fa-eye"></span></a></td>
                                                <td>
                                                    <form method="post"id="delete-form-{{ $mold->id }}" action="{{ route('mold.destroy',$mold->id) }}" style="dispaly: none">
                                                        {{ csrf_field()}}
                                                        {{ method_field('DELETE') }}
                                                    </form>
                                                    <a href="" onclick=" 
                                                        ...
                                                        {
                                                            event.preventDefault();document.getElementById('delete-form-{{ $mold->id }}').submit();
                                                        }
                                                        else
                                                        {
